...
data_folder='/mnt/hulk_tank/alfred_stuff/silver_surfer/Grimson_new_phylogeny/data/other_data/' #tell the program where your bed file is located (output will also go here)
input_bed_file='refseq_hg38.bed' #replace this with your own bed file
...
stats_folder=data_folder+'group4_stats/' #you can change output_stats_folder to something more memorable if desired
miRNA_file='/mnt/hulk_tank/alfred_stuff/silver_surfer/Grimson_new_phylogeny/data/real_eightmers_human_mouse_fish_best_group4'
