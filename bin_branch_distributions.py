...
for graph_type in graph_types:
	print graph_type, pairing
	output_file=open(stats_folder+pairing+'_distribution_'+graph_type, 'w')
	real_file=open(stats_folder+pairing+'_mir_ranks_'+graph_type)
	full_file=open(stats_folder+pairing+'real_'+graph_type)
