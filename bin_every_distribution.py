...
proportion of all 8mers. Modified to do this for every seed comparison
...
for graph_type in graph_types:
	print graph_type
	output_file=open(stats_folder+'distribution_'+graph_type+'_'+seed_comparison, 'w')
	real_file=open(stats_folder+'mir_ranks_'+graph_type+'_'+seed_comparison)
	full_file=open(stats_folder+'real_'+graph_type+'_'+seed_comparison)
