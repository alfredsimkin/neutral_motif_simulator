...
for stat in stat_list:
	rank_list=[]
	output_file=open(data_folder+'mir_ranks_'+stat, 'w')
	p_value_file=open(data_folder+'p_values_'+stat, 'w')
	all_8mers=[line.strip().split('\t') for line in open(data_folder+'real_'+stat)]
