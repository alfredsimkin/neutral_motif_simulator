...
def check_kmer(kmer_counts, anc_kmer, desc_kmer):
	'''
	configured for 5mers (pentamers)
	'''
	...
	if anc_kmer!=desc_kmer and anc_kmer[0]==desc_kmer[0] and anc_kmer[1]==desc_kmer[1] and anc_kmer[3]==desc_kmer[3] and anc_kmer[4]==desc_kmer[4]:
