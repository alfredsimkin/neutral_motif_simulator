...
import sys
full_dict={}
data_folder, replicate_start, replicate_end, mask_file, high_low=sys.argv[1:]
...
real_counts=cPickle.load(open(data_folder+'real_counts_'+high_low+'_AU_mask'))
...
full_dict=cPickle.load(open(data_folder+'full_sim_counts', 'rb'))
real={}
full_count=0
mean_counts={}
