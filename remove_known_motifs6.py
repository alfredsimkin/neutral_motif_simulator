...
gain_list=[line.strip().split() for line in open('bottom_1000_gains')]
loss_list=[line.strip().split() for line in open('bottom_1000_losses')]
sub_size=6
subs=[[1,7]]
bad_kmers=['TGT', 'TGCAT', 'AATAAA', 'ATTAAA', 'AGTAAA', 'TATAAA', 'CATAAA', 'GATAAA', 'AATATA', 'AATACA', 'AATAGA', 'ACTAAA', 'AAGAAA', 'AATGAA', 'ATTTA']
